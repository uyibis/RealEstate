    ...
    <div class="qodef-content-grid">
        <section class="qodef-m-heading">
            <div class="qodef-m-heading-left">
                ...
                <h2 class="qodef-m-heading-title">{{$listing->apartment_listing->title}}</h2>


                <div class="qodef-m-heading-bottom">
                    <div class="qodef-m-types qodef--desktop">
                        <a href="../../property-type/sell/index.html" rel="tag">{{$listing->apartment_listing->area}}</a> </div>
                    <div class="qodef-m-categories">
                        <a href="../../property-category/villas/index.html" rel="tag">{{$listing->apartment_listing->city}}</a> </div>
...
{{$listing->apartment_listing->price}} {{\App\Enum\Currency::Naira}}
 </span>
                    </div>
                </div>
            ...
            <div class="qodef-custom-slider">
                <div class="qodef-custom-slider--images swiper">
                    <div class="swiper-wrapper">
                        @foreach($listing->apartment_listing->images as $image)
                                ...
                                <div class="qodef-m-inner">
                                    <section class="qodef-m-description">
                                        <h4 class="qodef-m-description-title">Description</h4> <div class="qodef-m-description-content">
                                            <p>
                                                {{$listing->apartment_listing->description}}
                                            </p>
                                        </div>
                                    </section>
...
New York </span>
                        ...
                        <div class="qodef-grid-item qodef-page-sidebar-section qodef-col--sidebar">
                            {{asset('$listing->apartment_listing->realtor->image')}}
                            <section class="qodef-m-author">
                                <div class="qodef-m-author-top">
                                    <div class="qodef-m-author-image">
                                        <a itemprop="author" href="../../author/steve-parker/index.html">
                                            <img src="{{asset($listing->apartment_listing->realtor->image)}}" alt="b" width="100" height="100" data-ratio="1" />
                                        </a>
                                    </div>
                                    <div class="qodef-m-author-heading">
                                        <span class="qodef-m-author-heading-agency">{{env('AGENCY')}}</span>
                                        <h4 class="qodef-m-author-heading-name"> {{explode(' ' ,$listing->apartment_listing->realtor->name)[0]}}</h4>
                                        <span class="qodef-m-author-heading-address"> {{$listing->apartment_listing->realtor->address}} </span>
                                    </div>
                                </div>
                                <div class="qodef-m-author-content">
                                    <div class="qodef-m-author-content-item">
                                        ...
                                        <a itemprop="tel" class="qodef-m-author-content-item-text" href="tel:+2224445557"> {{$listing->apartment_listing->realtor->contact_number}} </a>
                                    </div>
                                </div>
