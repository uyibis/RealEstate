@foreach($building_listings as $land)
{{--    {{$land->building_listing}}--}}
    ...
    <div class="qodef-e-inner">
        <div class="qodef-e-image-holder">
            <div class="qodef-e-media-slider qodef-swiper-container" data-options="{&quot;slidesPerView&quot;:1,&quot;spaceBetween&quot;:5,&quot;loop&quot;:true,&quot;autoplay&quot;:false}">
                <div class="swiper-wrapper">
                    @foreach($land->building_listing->images as $image)
            ...
            <div class="qodef-e-author">
                <div class="qodef-e-author-image">
                    <a itemprop="url" href="author/steve-parker/index.html">
                        <img decoding="async" loading="lazy" src="{{asset($land->building_listing->realtor->image)}}" alt="b" width="50" height="50" data-ratio="1" />
                    </a>
                </div>
                <a itemprop="url" class="qodef-e-author-name" href="author/steve-parker/index.html">{{explode(' ', $land->building_listing->realtor->name)[0]}}</a>
            </div>
        </div>
        <div class="qodef-e-content">
                ...
                <div class="qodef-e-info">
                    ...
                    <div class="qodef-e-info-item qodef--category">
                        <a itemprop="url" class="qodef-e-info-item-link qodef--property-category" href="property-category/villas/index.html">
                            <span class="qodef-e-info-item-text">{{$land->building_listing->area}}</span>
                        </a>
                    </div>
                    ...
                    <div class="qodef-e-info-item qodef--location">
                        <a itemprop="url" class="qodef-e-info-item-link qodef--property-location" href="property-location/brooklyn/index.html">
                            <span class="qodef-e-info-item-text">{{$land->building_listing->city}}</span>
                        </a>
                    </div>
                    <span class="qodef-info-separator-end"></span>
                </div>
            ...
            <h4 itemprop="name" class="qodef-e-title entry-title">
                <a itemprop="url" class="qodef-e-title-link" href="property/south-sun-house/index.html">{{$land->building_listing->title}}</a>
            </h4>
            <p itemprop="description" class="qodef-e-excerpt">{{$land->building_listing->description}}</p>
            <div class="qodef-e-bottom-info">
                <div class="qodef-e-price">
                    <span class="qodef-e-price-amount qodef-h5"> {{$land->building_listing->price}}{{\App\Enum\Currency::Naira}}</span>
                </div>
