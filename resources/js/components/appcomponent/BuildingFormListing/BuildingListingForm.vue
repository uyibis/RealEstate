<template>
    <form id="listing_form" @submit="handleSubmit"   class="form-horizontal m-t-30">
        ...
        <div class="form-group">
            ...
            <input type="text" name="lot_size" class="form-control"   v-model="old.plot_size" placeholder="100 / 100">
        </div>
<!--        <div class="form-group">-->
<!--            <label>Bedroom :</label>-->
...
<!--        </div>-->
        <div class="form-group">
            ...
            <select class="form-select" name="garage"    v-model="old.garage" >
        ...
        async handleSubmit(event) {
            ...
            if (this.loader == false) {
                ...
                try {
                    ...
                    // Set the loader back to false, whether the request succeeds or fails
                    this.loader = false;
                }
            } else {
                this.loader = false;
